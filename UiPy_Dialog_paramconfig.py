...
class Ui_Dialog_paramconfig(QtGui.QDialog):
    def setupUi(self, Dialog_paramconfig):
        ...
        self.lineEdit_card1_best_frequency = QtGui.QLineEdit(self.layoutWidget)
        self.lineEdit_card1_best_frequency.setObjectName(_fromUtf8("lineEdit_card1_best_frequency"))
        self.gridLayout.addWidget(self.lineEdit_card1_best_frequency, 0, 1, 1, 1)
        ...
        self.lineEdit_card2_best_frequency = QtGui.QLineEdit(self.layoutWidget)
        self.lineEdit_card2_best_frequency.setObjectName(_fromUtf8("lineEdit_card2_best_frequency"))
        self.gridLayout.addWidget(self.lineEdit_card2_best_frequency, 1, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog_paramconfig):
        ...
        self.label_5.setText(_translate("Dialog_paramconfig", "Hz", None))
        self.label_3.setText(_translate("Dialog_paramconfig", "采集卡2最佳频率", None))
        self.label_2.setText(_translate("Dialog_paramconfig", "采集卡1最佳频率", None))
        self.label_6.setText(_translate("Dialog_paramconfig", "Hz", None))
